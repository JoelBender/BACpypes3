...
derivative of the console.py sample that looks for a BACpypes.yml settings
file, or the YAML file specified with the --yaml option.
"""
...
from bacpypes3.argparse import YAMLArgumentParser

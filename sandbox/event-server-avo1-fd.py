"""
Simple example that has a device object and an Analog Value Object with
fault detection and no intrinsic reporting.
"""
...
async def main() -> None:
    ...
    try:
        ...
        avo1 = AnalogValueObjectFD(
            ...
            presentValue=50.0,
            # object does not support event reporting, see Clause 12.4.7
